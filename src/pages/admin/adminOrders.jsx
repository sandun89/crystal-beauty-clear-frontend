                        ...
                        <tbody>
                            {
                                orders.map(
                                    (order, index) => {
                                        return(
                                            <tr key={index} onClick={ () => { setModalDisplay(true) }} className="border-b-[2px] border-gray-500 cursor-pointer hover:bg-gray-100">
                    ...
                    </table>
                    {
                        ...
                        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center backdrop-blur-[4px]">
                            <div className="w-[600px] h-[600px] max-h-[600px] relative bg-white">
                                ...
                                <div className="w-full h-[150px] bg-amber-200"></div>
